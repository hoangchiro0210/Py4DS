...
Original file is located at
    https://colab.research.google.com/drive/1s8Mt8R43AILB1xk72kainvBOFX4DzjOA
"""
...
def AUC_Score(X_train,y_train):
  ...
  model4 = GaussianNB()
  cross_val = KFold(n_splits=3, random_state=12)
  scores = cross_val_score(model4, X_train_C,y_train, cv=cross_val, scoring='roc_auc')
  return  scores.mean()
